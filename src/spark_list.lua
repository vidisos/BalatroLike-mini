...
---@type SparkBase[]
local spark_list = {
    spark1 = {image = spark_images.spark1, id = "spark1", title = LANG.spark_1_title, desc = LANG.spark_1_desc, activation_type = "passive", effect =
        ---@param self SparkBase
    ...
    spark14 = {image = spark_images.spark14, id = "banana", title = LANG.spark_14_title, desc = LANG.spark_14_desc, activation_type = "per-card", effect =
        ---@param self SparkBase
        ---@param gamestate GameState
        function(self, gamestate)
