...
local spark_list = {
    ...
    spark8 = {image = spark_images.spark8, id = "klif", title = LANG.spark_8_title, desc = LANG.spark_8_desc, activation_type = "passive", effect = function () end},
    spark9 = {image = spark_images.spark9, id = "errormessagelol", title = LANG.spark_9_title, desc = LANG.spark_9_desc, activation_type = "passive", effect = function () end},
    spark10 = {image = spark_images.spark10, id = "timetostop", title = LANG.spark_10_title, desc = LANG.spark_10_desc, activation_type = "passive", effect = function () end}
}
